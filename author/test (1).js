...
var REGISTRIES_CONFIG = [
    ...
    { registryCode: 'registries_measurement_methods', fieldName: 'entity_author' },
    { registryCode: 'reg_methods_verification_measuring_instruments', fieldName: 'entity_author' },
    { registryCode: 'Verifiers_of_measuring_instruments', fieldName: 'entity_author' },
    { registryCode: 'registries_measuring_methods_passed_metrological_certification', fieldName: 'entity_author' },
    { registryCode: 'registries_approved_types_of_measuring_instruments', fieldName: 'entity_author' },
    { registryCode: 'registries_approved_types_of_standard_samples', fieldName: 'entity_author' },
    { registryCode: 'Scientists_keepers_of_the_state_standards_of_units_of_quantities', fieldName: 'entity_author' },
    { registryCode: 'register_standards_of_units_of_quantities', fieldName: 'entity_author' },
    { registryCode: 'Application_for_admission_to_the_use_of_foreign_type_CO', fieldName: 'entity_author' },
